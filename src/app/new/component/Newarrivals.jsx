...
const NewArrivals = () => {
  ...
  // Simulate loading with potential API fetch
  useEffect(() => {
    const timer = setTimeout(() => {
  ...
  return (
    <div className="bg-gradient-to-b from-rose-50 to-white min-h-screen">
      {/* Hero Banner */}
      <div className="relative h-96 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-rose-800 to-rose-600 opacity-90" />
        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
          <motion.div
            initial="hidden"
            ...
            className="max-w-4xl mx-auto"
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 mt-16 font-serif">
              New Arrivals
            </h1>
            <p className="text-xl md:text-2xl text-white mb-8">
              Discover our latest ethnic wear collection for the season
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white cursor-pointer text-rose-700 px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all"
            >
              Shop Now
            </motion.button>
            </Link>
